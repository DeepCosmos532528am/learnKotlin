package LoopsInKotlin

/**
 * The function serves as the entry point of the program. It demonstrates the use of various Kotlin
...
fun main() {
    ...
    //Primarily, there are three types of loops - for(){ } loop, while(){ } loop,


    //1. for loop in kotlin - iterates over any iterable objects , like any range , array , list , queue.
    //for (variable is range / collection)
    for (i in 0..9) {
        println("Number: $i")
